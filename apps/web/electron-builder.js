module.exports = {
  ...
  win: {
    ...
    // Linux + Wine 环境下 rcedit 处理 Unicode 版本信息容易失败，关闭可执行文件编辑步骤
    signAndEditExecutable: false,
    // 仅产出 Windows x64 安装包（避免额外 zip 产物）
    target: [{ target: "nsis", arch: ["x64"] }],
    // Linux + Wine 下 rcedit 处理中文 exe 名称容易失败，Windows 可执行文件名保持 ASCII
    executableName: "aidoushangxueyuan",
    // eslint-disable-next-line no-template-curly-in-string
