...
export class ImageCell extends MessageCell<any, ImageCellState> {
    ...
    render() {
        ...
        return <MessageBase context={context} message={message}>
            <div style={{ width: scaleSize.width, height: scaleSize.height, cursor: "pointer", position: "relative" }} onClick={() => {
                this.setState({
                    showPreview: !this.state.showPreview,
                })
            }}>
                {this.getImageElement()}
                <div style={{ position: 'absolute', bottom: 4, right: 4, background: 'rgba(0,0,0,0.45)', borderRadius: 8, padding: '1px 6px', lineHeight: '18px' }}>
