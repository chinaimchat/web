...
import {
    parseClipboardImagePreview,
    parseClipboardVideoPreview,
...
export default class MessageInput extends Component<MessageInputProps, MessageInputState> implements MessageInputContext {
    ...
    private detachNativePasteListener() {
        if (this.nativePasteBoundEl && this.nativePasteListener) {
            this.nativePasteBoundEl.removeEventListener('paste', this.nativePasteListener, true);
        }
        this.nativePasteListener = undefined;
